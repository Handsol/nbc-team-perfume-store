...
export const addCartItem = async (cartData: AddCartData): Promise<TCartItem> => {
...
//장바구니 아이템 삭제하기
export const deleteCartItem = async (cartId: TCartItem['cart_id']): Promise<TCartItem> => {
...
//장바구니 전체 비우기(사용자)
export const deleteAllCart = async (userId: TCartItem['user_id']) => {
